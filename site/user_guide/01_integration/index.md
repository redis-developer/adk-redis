...
1. Wait 5 seconds for memory extraction
1. Session 2 (new session): "What do you remember about me?"
...
See the [fitness_coach_mcp example](https://redis-developer.github.io/adk-redis/user_guide/examples/fitness_coach_mcp/index.md) for a complete MCP integration example.
...
For MCP (Model Context Protocol) based integration, see the [fitness_coach_mcp example](https://redis-developer.github.io/adk-redis/user_guide/examples/fitness_coach_mcp/index.md).

...
**See:** [Agent Memory Server Setup Guide](https://redis-developer.github.io/adk-redis/user_guide/how_to_guides/memory_server_setup/index.md) for detailed configuration
...
1. Create database with "Search and Query" capability
1. Copy connection details from dashboard
